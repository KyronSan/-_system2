(function () {
    ...
    buttons.forEach(btn => {
        btn.addEventListener("click", () => {
            ...
            script.id = "cgScript";
            script.onload = () => {
                console.log(`IA cargada: ${diff}`);

                // Si la IA juega blancas, iniciar la primera jugada
                if (typeof turn !== "undefined" && turn === "w" && window.requestBlackMove) {
                    console.log("difficulty_switcher → iniciando jugada de IA blanca");
